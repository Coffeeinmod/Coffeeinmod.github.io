...
import { LanguageProvider } from "@/components/coffeein/language";
import appCss from "../styles.css?url";

const APP_NAME = "CoffeeinMod";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "CoffeeinMod — GTA 5 singleplayer. Fekete éjszaka, narancs neon. Coffeein script + GTA 5 mod.",
      },
